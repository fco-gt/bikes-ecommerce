...
export default function SidebarDashboard() {
  ...
  return (
    <aside className="flex flex-col fixed h-[90%] w-[250px] md:w-[350px] mw-[90%] bottom-0 left-0 overflow-hidden shadow-md rounded-r-xl rounded-t-xl border-t-1 border-r-1 bg-[#1A171A] border-[#5E5E5E]">
